...
import { Building2, Mail, Lock, User, ArrowRight, AlertCircle, Shield } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 relative overflow-hidden px-4">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-indigo-600/[0.08] rounded-full blur-[128px]" />
        <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] bg-violet-600/[0.06] rounded-full blur-[128px]" />
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-500 text-sm mt-1">Join Society Tracker today</p>
        </div>
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-2 py-3 px-4 rounded-xl border text-sm font-medium transition-all duration-200 ${
                    role === 'RESIDENT'
                      ...
                      : 'bg-white/[0.02] border-white/[0.08] text-gray-500 hover:text-gray-300 hover:bg-white/[0.04]'
                  }`}
                >
